...
class speedCanvas(Canvas):
    ...
    def drawSpeed(self,dir,value):
        ...
        self.node.publish(self.leftSpeed,self.rightSpeed)
...
class Driver(object):
    def __init__(self):
        ...
        self.publisher = rospy.Publisher("/motor_value",Motor_cmd,queue_size=1)
        rate = rospy.Rate(10)
        self.cmd = Motor_cmd()
        rospy.on_shutdown(self.on_shutdown)
    
    def publish(self,left,right):
        self.cmd.left_speed = left
        self.cmd.right_speed = right
